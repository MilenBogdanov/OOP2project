...
public class Main {
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            // Add handling for export command
            if (commandName.equals("export")) {
                System.out.print("Enter the table name and XML file name separated by space: ");
                String[] params = scanner.nextLine().split(" ", 2);
                commandCenter.executeCommand(commandName, params.length == 2 ? params[0] + " " + params[1] : "");
            }
...
} //continue with next bullshit update